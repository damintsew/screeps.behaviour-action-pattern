var mod = {
    extend: function(){
        ...
        Spawn.prototype.create = function(body, name, behaviour, destiny){
            ...
            if( DEBUG ) console.log( dye(CRAYON.system, this.pos.roomName + ' &gt; ') + dye(CRAYON.error, 'Offspring failed: ' + translateErrorCode(newName) + '<br/> - body: ' + JSON.stringify(_.countBy(body)) + '<br/> - name: ' + name + '<br/> - type: N/A ' + '<br/> - destiny: ' + destiny) );
            return false;
        };
        Spawn.loop = function(){
            var loop = spawn => {
